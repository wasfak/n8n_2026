      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Start with a free brief. Upgrade when you're ready.
          </p>
        </div>
        ...
        <div className="mx-auto mt-14 grid max-w-3xl gap-6 sm:grid-cols-2">
          ...
          <div className="rounded-2xl border border-border/50 bg-card p-8">
            <p className="text-sm font-semibold uppercase tracking-widest text-muted-foreground">Free Start</p>
            <div className="mt-4 flex items-baseline gap-1">
              <span className="font-display text-5xl font-extrabold text-foreground">$0</span>
            </div>
            <p className="mt-2 text-sm text-muted-foreground">Try it once — no credit card needed</p>
            ...
            <Button variant="outline" size="lg" className="mt-8 w-full">Start Free</Button>
          </div>
          ...
          <div className="relative rounded-2xl border-2 border-primary/30 bg-card p-8 shadow-xl shadow-primary/5">
            ...
            <p className="mt-2 text-sm text-muted-foreground">For solo operators and small teams</p>
            <ul className="mt-6 space-y-3">
            ...
            <Button variant="hero" size="lg" className="mt-8 w-full">Get Started</Button>
          </div>
        </div>

        <p className="mt-8 text-center text-sm text-muted-foreground">
          Simple and affordable. Built for individuals and small teams who want to sell smarter.
        </p>
      </div>
    </section>
  );
